...
namespace Project.Souccar.Core.Fasterflect.Emitter
{
    /// <summary>
    /// A wrapper for value type.  Must be used in order for Project.Souccar.Core.Fasterflect to 
    ...
    internal class ValueTypeHolder
    {
        ...
        /// can then be used with Project.Souccar.Core.Fasterflect.
        /// </summary>
